...
def classify(c):
    ...
    PHYSICAL_OBJECT = wkp(c, "Physical object")
    VALUE = wkd(c, 'Q614112')
    ...
    BREED = wkd(c, "Q38829")
    PLANT_STRUCTURE = wkd(c, "Q20011319")
    PLANT = wkd(c, "Q756")
    ...
    THREATENED_SPECIES = wkd(c, "Q16197023")
